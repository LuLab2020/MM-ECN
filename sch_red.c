		       ...
		       struct sk_buff **to_free)
{
	...
	//get qlen
	if(child->qstats.backlog) printk("i %d\n", child->qstats.backlog);
	...
	case RED_DONT_MARK:
		//printk(KERN_INFO "RED_DONT_MARK\n");
		break;

	case RED_PROB_MARK:
		//printk(KERN_INFO "RED_PROB_MARK\n");
	...
	case RED_HARD_MARK:
		//printk(KERN_INFO "RED_HARD_MARK\n");
		qdisc_qstats_overlimit(sch);
...
{
	printk("tm_ecn_module_init");
	return register_qdisc(&red_qdisc_ops);
}

static void __exit red_module_exit(void)
{
	printk("tm_ecn_module_exit");
